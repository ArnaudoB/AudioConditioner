...
\block{\textsc{The MusicDescriptor Schema}}{
    ...
    \begin{itemize}
        \item[\color{bleu303}\textbullet] \textbf{Mood} ($\rightarrow$ Multi-Label List): Emotional states (e.g., dark, epic, melancholic).
        \item[\color{bleu303}\textbullet] \textbf{Key/Mode} ($\rightarrow$ Single-Label): The musical scale used (e.g., major, minor).
        \item[\color{bleu303}\textbullet] \textbf{Instrumentation} ($\rightarrow$ Multi-Label List): Active instruments (e.g., strings, synth).
        \item[\color{bleu303}\textbullet] \textbf{Rhythm Style} ($\rightarrow$ Single-Label): Overall rhythmic feel (e.g., sparse, pulsing).
        \item[\color{bleu303}\textbullet] \textbf{Structure} ($\rightarrow$ Single-Label): Internal song progression (e.g., slow-build).
        \item[\color{bleu303}\textbullet] \textbf{Production Style} ($\rightarrow$ Multi-Label List): Mixing/Genre aesthetic (e.g., cinematic).
        \item[\color{bleu303}\textbullet] \textbf{Dynamics Profile} ($\rightarrow$ Single-Label): Volume progression (e.g., gradual build).
    \end{itemize}
    \medskip
    {\color{bleu315}\Large\scshape Regression Attributes}
    \begin{itemize}
        \item[\color{bleu303}\textbullet] \textbf{Energy} ($[0.0, 1.0]$): Intensity level.
        \item[\color{bleu303}\textbullet] \textbf{Valence} ($[0.0, 1.0]$): Emotional polarity (0.0 = sad, 1.0 = happy).
        \item[\color{bleu303}\textbullet] \textbf{Tempo} ($[50, 180]$ BPM): Beats per minute, normalized to $[0.0, 1.0]$.
        \item[\color{bleu303}\textbullet] \textbf{Harmonic Tension} ($[0.0, 1.0]$): Chord dissonance.
        \item[\color{bleu303}\textbullet] \textbf{Texture Density} ($[0.0, 1.0]$): Number of simultaneous elements.
    \end{itemize}
}
